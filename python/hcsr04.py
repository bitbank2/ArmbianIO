...
pin 10 (IRRX) and trig to pin 12 (IOG11). You can use a moving average and toss
out of bound values to get more accurate readings. Search around and you will
find out how. This program uses very little CPU.
